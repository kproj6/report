...
It is also important to decide a format in which the the raw data will be coded. This format should be as compact as possible, but definitely lossless. Because of the current architecture of the application, it would be preferable if this data was transmitted as \gls{JSON} (or at least packed in gls{JSON}).
