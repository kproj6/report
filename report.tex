...
\subsubsection{Rendering the data}
...
\subsection{Front-end}
The front-end consists of a single HTML file, the OpenLayers javascript library, custom javascript and CSS. These components combined make up the graphical user interface (GUI). It's role in the product is to help the user querying the back-end and then displaying the received data in a meaningful way. 
