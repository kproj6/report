...
A challange has been making FiMex command line tool available in the command line, due to a lot of hard-to-configure dependencies to build and install. Binary versions where not available for most of the dependency packages, nor is a binary version of FiMex available for those Operating Systems.
...
Fimex as a command line tool accepts parameters listed in its main website for the documentation\footnote{http://fimex.met.no/doc/programDoc.html}.
...
Understanding Fimex configuration files has been difficult, and required a considerable amount of work because of the poor documentation, and the almost total lack of relevant examples.
