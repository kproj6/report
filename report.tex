...
By running the following command gulp will watch all the source files in the \emph{src} folder. If any changes are made the nessesary compiling will be done automatically and the relevant files will be copied into it's respective folders in the \emph{dist} folder.
