...
Getting the projections done correctly has been a big difficulty in the project development and it will therefor need a lot of further work to serve all the functionality that is wanted, as well as to minimize the workload of the rest of the \gls{back-end} and human personel. \\ \\
