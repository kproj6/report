...
Notice: since the URL address of the back-end server may change according to the machine in which it is deployed,  in case of changing it is needed to configure this URL in the front-end as well. This can be done in the file \textit{src/js/script.js} in the first line of the \textit{buildurl()} function.
