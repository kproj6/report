...
With this string as a parameter, GeoTools didn't give any errors, and the conversion from PSP to LatLong has been performed correctly (a backwards conversion has been performed to check the result, as well as comparison with values provided by online conversion tools).
