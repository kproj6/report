...
This is a simple yet effecient way of manageing tasks. We chose Trello for the ease of use and the fact that it takes very little time to learn to use. In comparison a system like Jira \footnote{\url{http://https://www.atlassian.com/software/jira}} has more features that might have been useful but it takes more time and effort to learn, thus we opted for Trello.
